...
{- Extensional Martin-Löf Type Theory (with a countably many
Agda-style non-cumulative universes closed under Pi-types, natural
number type and equality types) and its semantics in the intensional
setoid model. -}
