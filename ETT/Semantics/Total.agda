module ETT.Semantics.Total where
...
tot⟦tm⟧ (⊢𝐬𝐮𝐜𝐜 p) =
  let
    ...
    e = (rflω C , π₂ (sv⟦ty⟧ q (⟦𝐍𝐚𝐭⟧ (ok⟦ty⟧ q))) ,
...
conv⟦tm⟧{Γ = Γ} (𝚷Eta{l}{l'}{A}{B}{b}{b'} X q₀ q₁ q₂ h₀ h₁)
  ...
  q = resp⟦tm⟧
    qt₁
    (rflω C , ((hrfl (ℱ𝒶𝓂 (max l l')) C (𝒫𝒾 l l' S T)) , t₁₀))
